...
def install_app(sdl_url_, *, sort_key=None, permissions_group: list = None, permissions_users: list = None):
    """
    Installs Stiction Analyser as an Add-on Tool in Seeq Workbench
    ...
    --------
    -: None
        Stiction Analyser will appear as Add-on Tool(s) in Seeq
        Workbench
    """
...
def cli_interface():
    """ Installs Stiction Analyser as a Seeq Add-on Tool """
    parser = argparse.ArgumentParser(description='Install Stiction Analyser as a Seeq Add-on Tool')
    ...
    parser.add_argument('--users', type=str, nargs='*', default=[],
                        help="List of the Seeq users to will have access to the Stiction Analyser Add-on Tool,"
                             " default: %(default)s")
    parser.add_argument('--groups', type=str, nargs='*', default=['Everyone'],
                        help="List of the Seeq groups to will have access to the Stiction Analyser Add-on Tool, "
                             "default: %(default)s")
...
if __name__ == '__main__':
    ...
    print(f"\nThe Stiction Analyser Tool will be installed on the SDL notebook: {sdl_url_sanitized}\n"
